    ...
    <main className="bg-animated" style={{
      ...
      <div className="glass" style={{
        ...
        <p style={{
          ...
          O <strong style={{ color: '#D4A843' }}>SaúdeGPT Nutrição</strong> é o curso completo 
          de Nutrição Clínica com inteligência artificial. Domine avaliação nutricional, 
          dietoterapia, nutrição esportiva e clínica com suporte de IA.
        </p>
        ...
        {enviado ? (
          <div style={{
            ...
            <p style={{ color: '#8899AA', fontSize: '0.85rem', marginTop: '0.5rem' }}>
              Aviseremos quando o curso de Nutrição estiver disponível.
            </p>
          </div>
        ) : (
